...
LangString qwenpawStopProcessesPrompt ${LANG_RUSSIAN} "Процессы QwenPaw всё ещё используют файлы, которые установщику нужно заменить.$\n$\nЗакройте QwenPaw и связанные сеансы командной строки, затем нажмите «Повторить». Нажмите «Отмена», чтобы прервать установку."
LangString qwenpawRestoreInstallStateFailed ${LANG_RUSSIAN} "Не удалось восстановить средство запуска Native Messaging; QwenPaw повторит попытку при запуске"
